...
export default class TelegramClient {
     ...
     * ```
     */
    setWebhook(url: string, options?: TelegramTypes.SetWebhookOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    sendMessage(chatId: string | number, text: string, options?: TelegramTypes.SendMessageOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    forwardMessage(chatId: string | number, fromChatId: string | number, messageId: number, options?: TelegramTypes.ForwardMessageOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendPhoto(chatId: string | number, photo: string, options?: TelegramTypes.SendPhotoOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendAudio(chatId: string | number, audio: string, options?: TelegramTypes.SendAudioOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendDocument(chatId: string | number, document: string, options?: TelegramTypes.SendDocumentOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendVideo(chatId: string | number, video: string, options?: TelegramTypes.SendVideoOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendAnimation(chatId: string | number, animation: string, options?: TelegramTypes.SendAnimationOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendVoice(chatId: string | number, voice: string, options?: TelegramTypes.SendVoiceOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendVideoNote(chatId: string | number, videoNote: string, options?: TelegramTypes.SendVideoNoteOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendMediaGroup(chatId: string | number, media: (TelegramTypes.InputMediaPhoto | TelegramTypes.InputMediaVideo)[], options?: TelegramTypes.SendMediaGroupOption): Promise<TelegramTypes.Message[]>;
    /**
     ...
     * ```
     */
    sendLocation(chatId: string | number, location: {
        latitude: number;
        longitude: number;
    }, options?: TelegramTypes.SendLocationOption): Promise<TelegramTypes.Message>;
    /**
    ...
    editMessageLiveLocation(location: {
        latitude: number;
        longitude: number;
    }, options: TelegramTypes.EditMessageLiveLocationOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    stopMessageLiveLocation(options: TelegramTypes.StopMessageLiveLocationOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    sendVenue(chatId: string | number, venue: TelegramTypes.Venue, options?: TelegramTypes.SendVenueOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendContact(chatId: string | number, requiredOption: TelegramTypes.SendContactRequiredOption, options?: TelegramTypes.SendContactOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendPoll(chatId: string | number, question: string, options: string[], otherOptions?: TelegramTypes.SendPollOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    sendChatAction(chatId: string | number, action: TelegramTypes.ChatAction): Promise<boolean>;
    /**
     ...
     * ```
     */
    getUserProfilePhotos(userId: number, options?: TelegramTypes.GetUserProfilePhotosOption): Promise<TelegramTypes.UserProfilePhotos>;
    /**
     ...
     * ```
     */
    kickChatMember(chatId: string | number, userId: number, options?: TelegramTypes.KickChatMemberOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    restrictChatMember(chatId: string | number, userId: number, permissions: TelegramTypes.ChatPermissions, options?: TelegramTypes.RestrictChatMemberOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    promoteChatMember(chatId: string | number, userId: number, options?: TelegramTypes.PromoteChatMemberOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    setChatPermissions(chatId: string | number, permissions: TelegramTypes.ChatPermissions): Promise<boolean>;
    /**
     ...
     * ```
     */
    pinChatMessage(chatId: string | number, messageId: number, options?: TelegramTypes.PinChatMessageOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    getChatMember(chatId: string | number, userId: number): Promise<TelegramTypes.ChatMember>;
    /**
     ...
     * ```
     */
    answerCallbackQuery(callbackQueryId: string, options: TelegramTypes.AnswerCallbackQueryOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    editMessageText(text: string, options?: TelegramTypes.EditMessageTextOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    editMessageCaption(caption: string, options?: TelegramTypes.EditMessageCaptionOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    editMessageMedia(media: TelegramTypes.InputMedia, options: TelegramTypes.EditMessageMediaOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    editMessageReplyMarkup(replyMarkup: TelegramTypes.InlineKeyboardMarkup, options?: TelegramTypes.EditMessageReplyMarkupOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    stopPoll(chatId: string | number, messageId: number, options?: TelegramTypes.StopPollOption): Promise<TelegramTypes.Poll>;
    /**
     ...
     * ```
     */
    sendSticker(chatId: string | number, sticker: string, options?: TelegramTypes.SendStickerOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    createNewStickerSet(userId: number, name: string, title: string, pngSticker: string, emojis: string, options?: TelegramTypes.CreateNewStickerSetOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    addStickerToSet(userId: number, name: string, pngSticker: string, emojis: string, options?: TelegramTypes.AddStickerToSetOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    answerInlineQuery(inlineQueryId: string, results: TelegramTypes.InlineQueryResult[], options?: TelegramTypes.AnswerInlineQueryOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    sendInvoice(chatId: number, product: TelegramTypes.Product, options?: TelegramTypes.SendInvoiceOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    answerShippingQuery(shippingQueryId: string, ok: boolean, options?: TelegramTypes.AnswerShippingQueryOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    answerPreCheckoutQuery(preCheckoutQueryId: string, ok: boolean, options?: TelegramTypes.AnswerPreCheckoutQueryOption): Promise<boolean>;
    /**
     ...
     * ```
     */
    sendGame(chatId: number, gameShortName: string, options?: TelegramTypes.SendGameOption): Promise<TelegramTypes.Message>;
    /**
     ...
     * ```
     */
    setGameScore(userId: number, score: number, options?: TelegramTypes.SetGameScoreOption): Promise<TelegramTypes.Message | boolean>;
    /**
     ...
     * ```
     */
    getGameHighScores(userId: number, options?: TelegramTypes.GetGameHighScoresOption): Promise<TelegramTypes.GameHighScore[]>;
}
